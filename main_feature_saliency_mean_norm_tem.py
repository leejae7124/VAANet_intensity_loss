...
#saliency 적용
import torch
from opts_tem import parse_opts

from core.model import generate_model_mean_norm_tem
...
def main():
    ...
    # opt.audio_mean = audio_mean.item() # tensor에서 float 값으로 변환
    # opt.audio_std = audio_std.item()
    # audio_mean, audio_std = -6.4479, 68.5871 #split 1
    # audio_mean, audio_std = -6.613560199737549, 70.09141540527344 #split2
    # audio_mean, audio_std = -6.461668014526367, 68.90550231933594 #split3
    ...
    model, parameters = generate_model_mean_norm_tem(opt)
